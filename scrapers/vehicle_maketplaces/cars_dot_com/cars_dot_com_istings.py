...
from helpers.utils.url.url import construct_url
from helpers.utils.json.append import append_json
from helpers.utils.csv.append import append_csv
from helpers.utils.selenium.webdriver import create_chrome_driver
...
def main():
    ...
    try:
        ...
        while True:
            ...
            # Save data to JSON
            append_json("./data/cars.com_listing_data.json", car_data)

            # Save data to CSV
            append_csv("./data/cars.com_listing_data.csv", car_data, ['name', 'price', 'dealer', 'location',
